    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-12">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-12 bg-indigo-900 rounded-xl overflow-hidden shadow-lg p-8 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between">
                    <div>
                        <h3 className="text-2xl font-bold text-white mb-2">전문가와 심층 상담이 필요하신가요?</h3>
                    ...
                    <div className="mt-6 md:mt-0 md:ml-8 flex-shrink-0">
                        <a
                            href="https://forms.gle/rxVu3dFYjRPNSHaY6"
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-base font-bold text-indigo-900 shadow-sm hover:bg-indigo-50 transition-colors"
                        >
                            전문가 상담 신청하기
                        </a>
                    </div>
