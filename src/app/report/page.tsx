...
export default async function ReportPage(props: { searchParams: Promise<{ id?: string }> }) {
    ...
    const profileStageLabel = profile?.stage ? STAGE_LABELS[profile.stage] || profile.stage : '단계 정보 없음'
    const profileIndustryLabel = profile?.industry ? INDUSTRY_LABELS[profile.industry] || profile.industry : '영역 정보 없음'
        ...
        <div className="min-h-screen bg-gray-50 pb-12 print:bg-white print:pb-0">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print:p-0 print:max-w-none">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 print:gap-4 print:grid-cols-1 print:break-inside-avoid">
                    ...
                    {/* Removed print:break-before-page to allow natural flow if space permits. */}
